...
import com.android.benben.mysplash.http.interceptor.CacheInterceptor;
import com.android.benben.mysplash.http.interceptor.LoggingInterceptor;
import java.io.File;
...
import static com.android.benben.mysplash.entity.Constants.API_DEBUG_SERVER_URL;


/**
 * Time      2017/6/26 16:51 .
 * Author   : LiYuanXiong.
 * Content  : 全局 单利网络请求Client 请求方法
 * 调用静态方法getInstance().***(); 其中*** 为ApiStore中定义的请求方法
 */
